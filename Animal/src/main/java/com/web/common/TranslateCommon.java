...
import com.web.common.translate.ApiKeys;
import com.web.common.translate.YandexTranslatorAPI;
import com.web.language.Language;
 ...
 */
public final class TranslateCommon extends YandexTranslatorAPI {
    ...
    public String translate(String text) {
        TranslateCommon.setKey(ApiKeys.YANDEX_API_KEY);
        try {
            String translation = execute(text, Language.ENGLISH, Language.VIETNAMESE);
            return translation;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
